...
// Function which prevents students form having same resources.
...
// Function that takes input for student 1
void *student0(){
...
// Function that takes input for student 2
void *student1() {
...
// Function that takes input for student 3
void *student2() {
...
// Function that determines the items with student
...
// Function that completes a student process accordingly
...
//Function that determine the exam hall,teacher and students
void *table() {
    int i, a, b, c, d, e, f;
    pthread_mutex_lock(&lockt);		
		a=1,b=2;
